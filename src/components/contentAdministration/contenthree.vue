    ...
    <div class="box">
      ...
      <div>
        <el-tabs v-model="activeName" @tab-click="handleClick" class="tab">
          ...
          <el-tab-pane label="成功案例" name="two">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="270"></el-table-column>
          ...
          <el-tab-pane label="产品" name="three">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="270"></el-table-column>
          ...
          <el-tab-pane label="公司新闻" name="four">
            ...
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              ...
              <el-table-column prop="tag" label="设置在首页" width="200">
                <template slot-scope="scope">
                  <el-button size="mini" @click="shezhi(scope.$index, scope.row)">设置</el-button>
                </template>
              </el-table-column>
              <el-table-column label="详情" width="200">
                <template slot-scope="scope">
          ...
          <el-tab-pane label="行业动态" name="five">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="270"></el-table-column>
          ...
          <el-tab-pane label="公司重大事项" name="sex">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="270"></el-table-column>
          ...
          <el-tab-pane label="人才发展" name="ten6">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="270"></el-table-column>
          ...
          <el-tab-pane label="员工关怀" name="ten7">
            <el-button type="primary" style="float:right;" @click="add()">添加</el-button>
            <el-table :data="tableData" style="width: 100%" :row-class-name="tableRowClassName">
              <el-table-column type="index" label="序号" width="50"></el-table-column>
              <el-table-column prop="articleTitle" label="文章名称" width="300"></el-table-column>
  ...
  methods: {
    ...
    shi1() {
      axios
        ...
        .then(res => {this.getData(this.categoryId)});
      this.dialog3 = false;
    },
    chongzhi(index, row) {
      console.log(index, row);
    ...
    getData(parmas) {
      axios.get("/plat/web/queryArticle?categoryId="+parmas+"&rows=" +
            this.pageSize +
            "&page=" +
            this.page)
